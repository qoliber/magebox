...
main() {
    ...
    echo ""
    echo -e "${YELLOW}IMPORTANT: Run bootstrap to complete setup:${NC}"
    echo ""
    echo "  mbox bootstrap"
    echo ""
    echo "This installs PHP, Nginx, configures permissions, and sets up Docker services."
    echo "You only need to run this once after installation."
    echo ""
    echo -e "${BLUE}After bootstrap, for each project:${NC}"
    echo "  1. Navigate to your Magento project directory"
    echo "  2. Run 'mbox init' to configure your project"
    echo "  3. Run 'mbox start' to start services"
    echo ""
